...
const routers = [
  ...
  },
  {
    ...
    component: resolve => require(["./views/template/createArticle.vue"], resolve)
  },
  {
    path: "/login",
    meta: {
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "details",
        name: "page-details-id",
        component: resolve => require(["./views/template/details.vue"], resolve),
        meta: {
          title: "details"
        }
      },
      ...
      },
      {
        path: "notice",
        name: "page-notice",
        component: resolve => require(["./views/template/notice.vue"], resolve),
        meta: {
          title: "notice"
        }
      },
      {
        path: "iep",
        name: "page-iep",
        component: resolve => require(["./views/template/iep.vue"], resolve),
        meta: {
          title: "iep"
        }
      },
      {
        path: "userCenter",
        name: "user-center",
        component: resolve => require(["./views/template/userCenter.vue"], resolve),
        meta: {
          title: "userCenter"
        }
      }
