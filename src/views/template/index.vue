...
<template>
		<div class="layout">
				<Layout>
						<Header style="position: fixed;width: 100%;background:#fff;padding:0 0;z-index: 1000; top:0">
												...
												<div class="header-warp">
													<div class="header-box">
														...
														<div class="layout-btn">
															<Button type="primary" icon="md-create" to="/createArticle">写分享</Button>
														</div>
													</div>
													<div class="layout-search">
															<Input v-model="searchValue" icon="md-search" placeholder="论ALSOLIFE的革命史" style="width: 300px" @on-enter="search()" />
													</div>
												</div>
						...
						<Content :style="{margin: '65px 0 0 0'}">
